 ...
 *
 * If you are making your theme translatable, you should replace 'sif'
...
// Standard Meta
	$options[] = array(
		...
		'type' => 'text');
	$options[] = array(
		'name' => __('Google Webmasters', 'sif'),
		'desc' => __("Speaking of Google, don't forget to set your site up: <a href='http://google.com/webmasters' target='_blank'>http://google.com/webmasters</a>", 'sif'),
		'id' => 'meta_google',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('Author Name', 'sif'),
		'desc' => __('Populates meta author tag.', 'sif'),
		'id' => 'meta_author',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('Mobile Viewport', 'sif'),
		'desc' => __('Uncomment to use; use thoughtfully!', 'sif'),
		'id' => 'meta_viewport',
...
// Icons
	$options[] = array(
		'name' => __('Site Favicon', 'sif'),
		'desc' => __('', 'sif'),
		'id' => 'head_favicon',
		'type' => 'upload');
	$options[] = array(
		'name' => __('Apple Touch Icon', 'sif'),
		'desc' => __('', 'sif'),
...
// App: Windows 8
	$options[] = array(
		'name' => __('App: Windows 8', 'sif'),
		'desc' => __('Application Name', 'sif'),
		'id' => 'meta_app_win_name',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'sif'),
		'desc' => __('Tile Color', 'sif'),
		'id' => 'meta_app_win_color',
		'std' => '',
		'type' => 'color');
	$options[] = array(
		'name' => __('', 'sif'),
		'desc' => __('Tile Image', 'sif'),
...
// App: Twitter
	$options[] = array(
		'name' => __('App: Twitter Card', 'sif'),
		'desc' => __('twitter:card (summary, photo, gallery, product, app, player)', 'sif'),
		'id' => 'meta_app_twt_card',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'sif'),
		'desc' => __('twitter:site (@username of website)', 'sif'),
		'id' => 'meta_app_twt_site',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'sif'),
		'desc' => __("twitter:title (the user's Twitter ID)", 'sif'),
		'id' => 'meta_app_twt_title',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'sif'),
		'desc' => __('twitter:description (maximum 200 characters)', 'sif'),
		'id' => 'meta_app_twt_description',
		'std' => '',
		'type' => 'textarea');
	$options[] = array(
		'name' => __('', 'sif'),
		'desc' => __('twitter:url (url for the content)', 'sif'),
		'id' => 'meta_app_twt_url',
		'std' => '',
		'type' => 'text');
...
// App: Facebook
	$options[] = array(
		'name' => __('App: Facebook', 'sif'),
		'desc' => __('og:title', 'sif'),
		'id' => 'meta_app_fb_title',
		'std' => '',
		'type' => 'text');
	$options[] = array(
		'name' => __('', 'sif'),
		'desc' => __('og:description', 'sif'),
