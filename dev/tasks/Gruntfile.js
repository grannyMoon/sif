/* Generated for Sverresborg Idrettsforening */
module.exports = function (grunt) {
    ...
    notify: {
      ...
      distDone: {
        options: {
          ...
          message: "Sverresborg Idrettsforening is ready to be distributed ", //needed escaping!
        }
      },
      sassDone: {
        options: {
  ...
  //RUN FOR PRODUCTION 
  grunt.registerTask('prod',       ['notify:distStart', 'bowercopy:libs', 'prepJS', 'prepImages', 'prepStyles', 'prepFonts', 'compress:production', 'notify:distDone']);
